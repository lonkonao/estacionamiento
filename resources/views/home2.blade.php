...
<head>
    ...
    <!-- Bootstrap -->
    <link href="{{ asset('../util/css/bootstrap.min.css'}}" rel="stylesheet">
    <!-- styles -->
    <link href="{{ asset('../util/css/styles.css'}}" rel="stylesheet">
...
<script src="{{ asset('../util/bootstrap/js/bootstrap.min.js'}}"></script>

<script src="{{ asset('../util/vendors/datatables/js/jquery.dataTables.min.js'}}"></script>

<script src="{{ asset('../util/vendors/datatables/dataTables.bootstrap.js'}}"></script>

<script src="{{ asset('../util/js/custom.js'}}"></script>
<script src="{{ asset('../util/js/tables.js'}}"></script>
</body>
</html>